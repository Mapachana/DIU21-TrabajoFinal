...
Ahora el objetivo de la página es ofrecerte información sobre las actividades culturales que se están llevando a cabo en Granada, Málaga y Sevilla y ofertas en muchas de estas actividades a los miembros suscritos. Es decir, su producto ya no es solo la revista, también es intentar que te suscribas para obtener las ventajas que ofrecen.
...
<img src="./img/responsivo1.jpg" style="zoom:25%;" align="center;" />
...
Para la tipografía, voy a usar "Source Serif Pro" para la web por su legibilidad y simpleza, además de que es la usada en la revista, y para los títulos usaré "Maitree" ya que es una fuente similar a la empleada en el logo.

![](./img/sourceserifpro.png)

![](./img/maitree.png)

Primero he realizado el wireframe de las páginas más relevantes de la web: home, la página de eventos y la página para descargar la revista. Las páginas de descrición de una actividad y la de ayuda seguirán una estructura similar a las ya rèpresentadas aquí.
...
* [**Home Link**](http://ui-patterns.com/patterns/HomeLink): Utilizamos el logo de la aplicación como enlace directo y desde cualquier página a la página principal (Home). Este patrón afecta a toda la web, haciendo siempre accesible el home de la web en cualquier momento.
...
* [**Tagging**](http://ui-patterns.com/patterns/Tag): Las diversas actividades y establecimientos ofertados admiten etiquetas para simplificar las búsquedas según temas. Además, al buscar eventos estos aparecen con una franja de color (rojo, morado, azul o verde) que indica qué temática tiene cada uno. Por ejemplo, las visitas guiadas llevan una franja verde, las musicales una roja, las exposiciones de arte y literatura una azul y las representaciones de teatro una morada, facilitando así al usuario reconocer la temática de cada evento ofertado sin necesidad de leer la descripción.

* [**Frequently Asked Questions (FAQ)**](http://ui-patterns.com/patterns/frequently-asked-questions-faq): Dedicamos una sección de la web a preguntas que suelen repetir los usuarios, de manera que los mismos tengan acceso rápido y sencillo a soluciones frecuentes, facilitando el uso de la aplicación a nuevos usuarios o personas con poco conocimiento en el campo de tecnologías, así como evitamos una saturación del contacto.
...
* [**Lazy Registration**](http://ui-patterns.com/patterns/LazyRegistration): Permitimos que cualquier usuario que acceda a la web pueda navegar sin ningún problema sin necesidad de registrarse.
